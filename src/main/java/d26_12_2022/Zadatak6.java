...
public class Zadatak6 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(euro+ " eura je " + konverzija(euro, valuta) + valuta);

    }

    public static double konverzija (double euro, String valuta){
      if (valuta.equals("RSD"))  {
          double euroURsd= 117.5*euro;
          return euroURsd;

      }
      else if (valuta.equals("USD")){
          double euroUUsd= 1.1*euro;
          return euroUUsd;
      }
      else if (valuta.equals("RUB")){
          double euroURub= 62.98*euro;
          return euroURub;
      }
      else {
          return 0;
